...
http.createServer(function(req, res) {
	...
	if (req.url === "/admin") {
		...
		fs.readFile("./AdminPage/Stats.html", "UTF-8", function(err, html) {
			res.writeHead(200, {"Content-Type": "text/html"});
			res.end(html);
		});
	}
	else if (req.url == "/graphStyles.css"){
		var fileStream = fs.createReadStream("./AdminPage/graphStyles.css", "UTF-8");
